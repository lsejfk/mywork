    ...
    <div class="page-group">
        ...
        <div class="page current-page" id="mytab1">
            ...
            <nav class="bar bar-tab">
              ...
              <a class="tab-item external" onclick="remove_badge()" data-no-cache="true" href="/weipro/share_record.php">
                <span class="icon icon-friends"></span>
                <span class="tab-label">分享记录</span>
                 <span id="thebadge1" class="thebadge"><?php echo $thebadgeStr?></span>
              </a>
              <a class="tab-item external" data-no-cache="true" href="/weipro/view/myinfo.php">
            	...
            	<div class="content">
                	<div class="buttons-tab">
                        <a href="#mytab1" data-no-cache="true" class="active button">未使用</a>
                        <a href="#mytab2" data-no-cache="true" class="button">已使用</a>
                        <a href="#mytab3" data-no-cache="true" class="button">过期</a>
                      </div>
            ...
            <nav class="bar bar-tab">
              ...
              <a class="tab-item external" onclick="remove_badge()" data-no-cache="true" href="/weipro/share_record.php">
               ...
               <a class="tab-item external" data-no-cache="true" href="/weipro/view/myinfo.php">
            	...
            	<div class="content">
                	<div class="buttons-tab">
                       <a href="#mytab1" data-no-cache="true" class="button">未使用</a>
                        <a href="#mytab2" data-no-cache="true" class="button active">已使用</a>
                        <a href="#mytab3" data-no-cache="true" class="button">过期</a>
                      </div>
                      <div class="content-block">
               ...
               <a class="tab-item external" data-no-cache="true" href="/weipro/view/myinfo.php">
            	...
            	<div class="content">
                	<div class="buttons-tab">
                        <a href="#mytab1" data-no-cache="true" class="button">未使用</a>
                        <a href="#mytab2" data-no-cache="true" class="button">已使用</a>
                        <a href="#mytab3" data-no-cache="true" class="button active">过期</a>
                      </div>
                      <div class="content-block">
