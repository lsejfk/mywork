...
if(!isset($_COOKIE['weipro']['id']) || !$control->is_login($_COOKIE['weipro']['id'])){
    info_to_user("您未登录","info","确定","http://youpinyougou.club/weipro/index.php?page=login");
}
...
if(isset($_GET['type'])){
    if($_GET['type'] == "share"){
        ...
        $vcode_parm = "http://youpinyougou.club/weipro/show_vcode.php?type=share&cou_id={$_GET['cou_id']}&user_id=$user_id";
        $share_title = $control->get_coupon_title($_GET['cou_id']);
        $temp['page_title'] = "我的分享码";
        $temp['head_title'] = "优惠券分享";
        $temp['note'] = "【优品油购】【{$share_title}】分享给你快去使用吧！";
        ...
        $vcode_parm = "http://youpinyougou.club/weipro/show_vcode.php?type=use&cou_id={$_GET['cou_id']}&user_id=$user_id";
        $share_title = $control->get_coupon_title($_GET['cou_id']);
        $temp['page_title'] = "我的分享码";
            ...
            <div class="card demo-card-header-pic">
                ...
                <div class="card-content">
                  <div class="card-content-inner">
                    ...
                    <p class="color-gray">提示：您可以将此页面截图分享给朋友。</p>
                    <p class="color-gray">地址：湘乡市湘乡政务后100米优品油购汽车保养中心</p>
