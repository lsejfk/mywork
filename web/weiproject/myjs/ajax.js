...
function show_full_subtra()
{
  ...
  xmlhttp.open("GET","/weipro/view/ajax_handle.php?type=full_subtra",true);
  xmlhttp.send();
}
...
function show_calender()
{
  ...
  xmlhttp.open("GET","/weipro/view/ajax_handle.php?type=time_calender",true);
  xmlhttp.send();
}
...
function show_days()
{
  ...
  xmlhttp.open("GET","/weipro/view/ajax_handle.php?type=time_days",true);
  xmlhttp.send();
}
...
function show_cou_avi_list()
{
  ...
  xmlhttp.open("GET","/weipro/view/ajax_handle.php?type=reward_cou",true);
  xmlhttp.send();
}
...
function show_other_list()
{
  ...
  xmlhttp.open("GET","/weipro/view/ajax_handle.php?type=other_list",true);
  xmlhttp.send();
}
